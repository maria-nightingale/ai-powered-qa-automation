 ...
 *
 * Requires in .env:
 *   DIDAXIS_URL (optional, default: https://test.didaxis.studio)
 *   DIDAXIS_API_TOKEN (optional)
 *   DIDAXIS_EMAIL / DIDAXIS_PASSWORD (used when token is missing or invalid)
 *
 * Usage:
 *   node scripts/delete-all-programs.mjs           # dry run
 *   node scripts/delete-all-programs.mjs --confirm # delete all listed programs
 */
